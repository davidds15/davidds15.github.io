                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-3 ml-5 filter">
                                ...
                                <div class="row">
                                <form method='POST' action="<?php echo e(route('Filterbulan')); ?>">
                                        <?php echo csrf_field(); ?>
                                        <div class="">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.xoric', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ProjectKP-master\resources\views/penjadwalan/listjadwal.blade.php ENDPATH**/ ?>