                                            ...
                                            <tbody>
                                              <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                  ...
                                                  <td>
                                                  <a href="<?php echo e(url('customer/'.$d->id.'/edit')); ?>" class='btn btn-xs btn-info'>edit</a>
                                                  </td>
                                                  <td>                                                   
                                                    <form method='POST' action="<?php echo e(url('customer/'.$d->id)); ?>">
                                                    <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.xoric', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ProjectKP_v2\resources\views/customer/index.blade.php ENDPATH**/ ?>