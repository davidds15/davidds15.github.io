...
<head>
	...
	<!-- BEGIN THEME STYLES -->
	<link href="<?php echo e(asset('assets/css/style-conquer.css')); ?>" rel="stylesheet" type="text/css"/>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/plugins/datatables/plugins/bootstrap/dataTables.bootstrap.css')); ?>"/>
	<!-- END THEME STYLES -->
...
<div class="header navbar  navbar-fixed-top">
	...
	<div class="header-inner">
		...
		<a href="javascript:;" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
			<img src="<?php echo e(asset('assets/img/menu-toggler.png')); ?>" alt=""/>
		</a>
		...
		<ul class="nav navbar-nav pull-right">
						...
						<ul class="dropdown-menu-list scroller" style="height: 250px;">
							<li>
								<a href="inbox.html?a=view">
										<span class="photo">
											<img src="<?php echo e(asset('assets/img/avatar2.jpg')); ?>" alt=""/>
										</span>
									<span class="subject">
											<span class="from">
											Lisa Wong </span>
							...
							<li>
								<a href="inbox.html?a=view">
										<span class="photo">
											<img src="<?php echo e(asset('assets/img/avatar3.jpg')); ?>" alt=""/>
										</span>
									<span class="subject">
											<span class="from">
											Richard Doe </span>
							...
							<li>
								<a href="inbox.html?a=view">
										<span class="photo">
											<img src="<?php echo e(asset('assets/img/avatar1.jpg')); ?>" alt=""/>
										</span>
									<span class="subject">
											<span class="from">
											Bob Nilson </span>
			...
			<li class="dropdown user">
				<a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
				   data-close-others="true">
					<img alt="" src="<?php echo e(asset('assets/img/avatar3_small.jpg')); ?>"/>
					<span class="username">
	...
	<div class="page-sidebar-wrapper">
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu">
				...
				<li class="start <?php echo e(Request::is('/') ? 'active' : ''); ?> ">
				...
				<li class="<?php echo e(Request::is('products*') ? 'active' : ''); ?> <?php echo e(Request::is('jenisPelayanan') ? 'active' : ''); ?><?php echo e(Request::is('customer*') ? 'active' : ''); ?>">
					<a href="javascript:;">
					...
					<li class="<?php echo e(Request::is('customer*') ? 'active' : ''); ?>">
						...
						<li class="<?php echo e(Request::is('jenisPelayanan') ? 'active' : ''); ?>">
							<a href="<?php echo e(url('jenisPelayanan')); ?>">
...
<!-- BEGIN CORE PLUGINS -->
<script src="<?php echo e(asset('assets/plugins/jquery-1.11.0.min.js')); ?>" type="text/javascript"></script>
...
<script src="<?php echo e(asset('assets/plugins/jquery-ui/jquery-ui-1.10.3.custom.min.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('assets/plugins/bootstrap/js/bootstrap.min.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('assets/plugins/bootstrap-hover-dropdown/bootstrap-hover-dropdown.min.js')); ?>" type="text/javascript"></script>
...
<script src="<?php echo e(asset('assets/plugins/jquery.editable.min.js')); ?>" type="text/javascript"></script>

<script type="text/javascript" src="<?php echo e(asset('assets/plugins/datatables/media/js/jquery.dataTables.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('assets/plugins/datatables/plugins/bootstrap/dataTables.bootstrap.js')); ?>"></script>
<!-- END CORE PLUGINS -->
...
<!-- END BODY -->
</html><?php /**PATH C:\xampp\htdocs\ProjectKP_v2\resources\views/layout/conquer.blade.php ENDPATH**/ ?>