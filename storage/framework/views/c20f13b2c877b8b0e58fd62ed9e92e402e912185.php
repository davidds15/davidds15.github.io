...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Login | Satelit Servis Dashboard</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mb-5">
                            <h5 class="font-size-16 text-white-50 mb-4">Satelit Servis Login Dashboard</h5>
                        </div>
                    </div>
                </div>
                <!-- end row -->
...
<?php /**PATH C:\xampp\htdocs\ProjectKP-master\resources\views/auth/login.blade.php ENDPATH**/ ?>