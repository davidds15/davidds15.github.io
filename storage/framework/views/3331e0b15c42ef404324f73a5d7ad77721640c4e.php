                                            ...
                                            <form method="POST" action="<?php echo e(route('customer.store')); ?>">
                                             <?php echo csrf_field(); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <input data-parsley-type="number" type="text" name="nomor"
...
<?php echo $__env->make('layout.xoric', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ProjectKP_v2\resources\views/customer/create.blade.php ENDPATH**/ ?>