...
<head>
    ...
    <link href="<?php echo e(asset('assets/libs/datatables.net-responsive-bs4/css/responsive.bootstrap4.min.css')); ?>" rel="stylesheet"
        type="text/css" />
    <!-- datepicker -->
    <link href="<?php echo e(asset('assets/libs/air-datepicker/css/datepicker.min.css')); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(asset('assets/libs/fullcalendar/fullcalendar.min.css')); ?>" rel="stylesheet" type="text/css" />
    <!-- jvectormap -->
    ...
    <?php echo $__env->yieldContent('tempat_css'); ?>
...
<body data-topbar="colored">
    ...
    <div id="layout-wrapper">
                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box">
                        <a href="/home" class="logo logo-dark">
                            <span class="logo-sm">
                                <img src="<?php echo e(asset('assets/images/logo-sm-dark.png')); ?>" alt="" height="22">
                            </span>
                            <span class="logo-lg">
                        ...
                        <a href="index.html" class="logo logo-light">
                            <span class="logo-sm">
                                <img src="<?php echo e(asset('assets/images/logo-sm-light.png')); ?>" alt="" height="22">
                            </span>
                            <span class="logo-lg">
                ...
                <div class="d-flex">
                    ...
                    <!-- <div class="dropdown d-inline-block">
                            <!-- <button type="button" class="btn header-item waves-effect" id="page-header-flag-dropdown"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="" src="<?php echo e(asset('assets/images/flags/us.jpg')); ?>" alt="Header Language" height="14">
                            </button> -->
                    <!-- <div class="dropdown-menu dropdown-menu-right">
        
                                item
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <img src="<?php echo e(asset('assets/images/flags/spain.jpg')); ?>" alt="user-image" class="mr-2" height="12"><span class="align-middle">Spanish</span>
                                </a>

                                item
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <img src="<?php echo e(asset('assets/images/flags/germany.jpg')); ?>" alt="user-image" class="mr-2" height="12"><span class="align-middle">German</span>
                                </a>

                                item
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <img src="<?php echo e(asset('assets/images/flags/italy.jpg')); ?>" alt="user-image" class="mr-2" height="12"><span class="align-middle">Italian</span>
                                </a>

                                item
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <img src="<?php echo e(asset('assets/images/flags/russia.jpg')); ?>" alt="user-image" class="mr-2" height="12"><span class="align-middle">Russian</span>
                                </a>
                            </div> -->
                    <!-- </div> --> -->
                    ...
                    <div class="dropdown d-inline-block">
                        <!-- <button  class="btn header-item noti-icon waves-effect">
                                <a href="/cart" ><i class="mdi mdi-cart"></i><span class="badge badge-danger"><?php echo e(count((array) session('cart'))); ?></span></a></button> -->
                    </div>
                    ...
                    <div class="dropdown d-inline-block">
                        <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                            ...
                            <img class="rounded-circle header-profile-user"
                                src="<?php echo e(asset('assets/images/users/avatar-1.jpg')); ?>" alt="Header Avatar">
                            <span class="d-none d-sm-inline-block ml-1"><?php echo e(Auth::user()->namauser); ?></span>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <?php echo $__env->yieldContent('tempat_konten'); ?>
                <!-- Page-Title -->
                ...
                <div class="tab-pane active" id="chat-tab" role="tabpanel">
                    ...
                    <div class="p-2">
                        <a href="javascript: void(0);" class="text-reset notification-item">
                            <div class="media">
                                <div class="position-relative align-self-center mr-3">
                                    <img src="<?php echo e(asset('assets/images/users/avatar-10.jpg')); ?>"
                        ...
                        <a href="javascript: void(0);" class="text-reset notification-item">
                            <div class="media">
                                <div class="position-relative align-self-center mr-3">
                                    <img src="<?php echo e(asset('assets/images/users/avatar-9.jpg')); ?>"
                                        class="rounded-circle avatar-xs" alt="user-pic">
                    ...
                    <div class="p-2 pb-4">
                        ...
                        <a href="javascript: void(0);" class="text-reset notification-item">
                            <div class="media">
                                <div class="position-relative align-self-center mr-3">
                                    <img src="<?php echo e(asset('assets/images/users/avatar-7.jpg')); ?>"
                                        class="rounded-circle avatar-xs" alt="user-pic">
                                    <i class="mdi mdi-circle user-status busy"></i>
                                </div>
                                <div class="media-body overflow-hidden">
    ...
    <!-- datepicker -->
    <script src="<?php echo e(asset('assets/libs/air-datepicker/js/datepicker.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/libs/air-datepicker/js/i18n/datepicker.en.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('assets/libs/fullcalendar/fullcalendar.min.js')); ?>"></script>
    ...
    <?php echo $__env->yieldContent('tempat_js'); ?>
    ...
    <?php echo $__env->yieldContent('tempat_script'); ?>
</body>

</html><?php /**PATH C:\xampp\htdocs\ProjectKP-master\resources\views/layout/xoric.blade.php ENDPATH**/ ?>